...
#执行程序名称
PROGRAM_NAME="tc-config-server.jar"
PORT=10012
...
SPRING_CLOUD_PROFILE=${SPRING_CLOUD_PROFILE}" --eureka.client.serviceUrl.defaultZone=http://eurekaserver1.com:10001/eureka/,http://eurekaserver2.com:10001/eureka/,http://eurekaserver3.com:10001/eureka/,http://eurekaserver4.com:10001/eureka/,http://eurekaserver5.com:10001/eureka/"
