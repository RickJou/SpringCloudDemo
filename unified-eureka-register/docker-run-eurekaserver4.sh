...
#执行程序名称
PROGRAM_NAME="tc-eureka-register.jar"
PORT=10024

#spring cloud启动配置相关
SPRING_CLOUD_PROFILE="--server.port="${PORT}
SPRING_CLOUD_PROFILE=${SPRING_CLOUD_PROFILE}" --spring.cloud.inetutils.preferredNetworks[0]=eurekaconfig4.com"
SPRING_CLOUD_PROFILE=${SPRING_CLOUD_PROFILE}" --spring.profiles.active=registry1"
SPRING_CLOUD_PROFILE=${SPRING_CLOUD_PROFILE}" --eureka.client.serviceUrl.defaultZone=http://eurekaserver1.com:10001/eureka/,http://eurekaserver2.com:10002/eureka/,http://eurekaserver3.com:10003/eureka/,http://eurekaserver5.com:10005/eureka/"

#java环境相关
JAVA_HOME=/software/jdk1.8.0_73
JAVA_OPTS="-Xms1024m -Xmx1024m -Xss256k -XX:MetaspaceSize=128m -XX:MaxMetaspaceSize=128m -XX:NewSize=650m -XX:MaxNewSize=650m -XX:SurvivorRatio=22"  
