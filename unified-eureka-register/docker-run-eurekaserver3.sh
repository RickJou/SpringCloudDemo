...
SPRING_CLOUD_PROFILE=${SPRING_CLOUD_PROFILE}" --spring.cloud.inetutils.preferredNetworks[0]=eurekaconfig3.com"
SPRING_CLOUD_PROFILE=${SPRING_CLOUD_PROFILE}" --spring.profiles.active=registry1"
SPRING_CLOUD_PROFILE=${SPRING_CLOUD_PROFILE}" --eureka.client.serviceUrl.defaultZone=http://eurekaserver1.com:10001/eureka/,http://eurekaserver2.com:10002/eureka/,http://eurekaserver4.com:10004/eureka/,http://eurekaserver5.com:10005/eureka/"
