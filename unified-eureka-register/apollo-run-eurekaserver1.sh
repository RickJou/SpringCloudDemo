...
SPRING_CLOUD_PROFILE=${SPRING_CLOUD_PROFILE}" --eureka.client.serviceUrl.defaultZone=http://eurekaconfig2.com:10001/eureka/,http://eurekaconfig3.com:10001/eureka/"
